...
(let* ((aluminium-1 "#eeeeec")
  ...
  (custom-theme-set-faces
   ...
   `(custom-group-tag ((t (:bold t :foreground ,orange-2))))
   `(custom-variable-tag ((t (:bold t :foreground ,butter-2))))
   `(custom-face-tag ((t (:bold t :foreground ,butter-2))))
   ...
   ;; org-mode
   `(org-level-1 ((t (:bold t :foreground ,gradient-1))))
   `(org-level-2 ((t (:bold t :foreground ,gradient-2))))
   `(org-level-3 ((t (:bold t :foreground ,gradient-3))))
   ...
   `(org-document-title ((t (:bold t :foreground ,sky-blue-1))))
   ...
   `(org-agenda-date ((t (:foreground ,butter-1))))
   `(org-agenda-date-today ((t (:inherit 'org-agenda-date :foreground ,butter-2 :weight bold))))
   ...
   ;; rst-mode
   `(rst-level-1-face ((t (:foreground ,black))))
   `(rst-level-2-face ((t (:foreground ,black))))
   `(rst-level-3-face ((t (:foreground ,black))))
   `(rst-level-4-face ((t (:foreground ,black))))
   `(rst-level-5-face ((t (:foreground ,black))))
